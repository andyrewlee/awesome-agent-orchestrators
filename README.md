...
- [DevIntern](https://github.com/getdevintern/devintern) - Picks up tickets from Jira, Linear, Trello, Asana, Azure DevOps, GitHub Issues, or markdown and turns them into self-reviewed PRs, driving Claude Code, Codex, Cursor, OpenCode, Gemini CLI, and others on your machines. Feasibility gate for vague tickets; optional unattended mode with scheduled pickup and review-comment commits.
