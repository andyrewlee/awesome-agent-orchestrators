...
- [OrcaPromptVault](https://github.com/Continuum-AI-Corp/OrcaPromptVault) - Archives the system prompts and tool declarations harnesses send before your first token, recorded off the wire and dated per version: Claude Code 35 tools interactively against 29 under `claude -p`, OpenClaw 38, Crush 26, dsh 25. 119 files from 43 products, 44 of them recorded.
