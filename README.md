...
- [CodeAgentSwarm](https://www.codeagentswarm.com) - Desktop app for running multiple Claude Code, Codex CLI, and Antigravity agents in parallel supervised terminals with notifications, session history, per-terminal diffs, and an MCP kanban board.
