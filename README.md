...
- [Dispatcher](https://getdispatcher.dev) - Desktop and web command center running coding agents as live PTYs in isolated git worktrees, with in-app diff review and one-click PRs. Cloud adds tasks, knowledge, and Slack/Linear/GitHub intake. Claude Code, Codex, Cursor, OpenCode, Antigravity, Grok, Pi, Hermes.
