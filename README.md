...
- [coleo](https://coleo.dev) - Implements a biological metaphor to manage plans and tasks for parallel execution, where human operators use CLI, Web, email and spreadsheets to instruct the brain which keeps reevaluating the project as work progresses.
