...
- [bernstein](https://github.com/chernistry/bernstein) - Declarative orchestrator for CLI coding agents (Claude Code, Codex, Gemini CLI, Aider, 20+ more). Deterministic Python scheduler, git worktree isolation, quality gates, cost tracking. Apache-2.0.
