...
- [Podium ADE](https://github.com/madeinorbit/podium) - Open-source ADE where you ask a coding agent to organize connected issues and coordinate Claude Code, Codex, Cursor, OpenCode, and Grok, with desktop, web, and phone access.
