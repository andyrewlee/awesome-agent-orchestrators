...
- [bernstein](https://github.com/chernistry/bernstein) - One command spawns parallel AI coding agents (Claude Code, Codex, Gemini CLI), verifies output with tests, commits clean code. Deterministic Python orchestration — zero LLM tokens on coordination.
